...
public class ActivatedSpawnerDetector extends Module {
    ...
    public ActivatedSpawnerDetector() {
        super(Categories.World, "ActivatedSpawnerDetector", "Detects if a player has been near a mob spawner in the past. May be useful for finding player made stashes in dungeons, mineshafts, and other places.");
    }
